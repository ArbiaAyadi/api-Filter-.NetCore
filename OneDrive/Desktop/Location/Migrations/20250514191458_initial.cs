    ...
    public partial class initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Maison", x => x.MaisonId);
                    table.ForeignKey(
                        name: "FK_Maison_Client_ClientId",
                        column: x => x.ClientId,
                        principalTable: "Client",
                        principalColumn: "ClientId");
                    table.ForeignKey(
                        name: "FK_Maison_Owner_OwnerId",
                        column: x => x.OwnerId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Payment_Maison_MaisonId",
                        column: x => x.MaisonId,
                        principalTable: "Maison",
                        principalColumn: "MaisonId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Review_Maison_MaisonId",
                        column: x => x.MaisonId,
                        principalTable: "Maison",
                        principalColumn: "MaisonId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Maison_ClientId",
                table: "Maison",
                column: "ClientId");

            migrationBuilder.CreateIndex(
                name: "IX_Maison_OwnerId",
                table: "Maison",
                column: "OwnerId");
